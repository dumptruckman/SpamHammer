...
public class TestInstanceCreator {
    ...
    public boolean setUp() {
        ...
        try {
            ...
            PluginDescriptionFile pdf = new PluginDescriptionFile("SpamHammer", "2.0",
                    "com.dumptruckman.spamhammer.SpamHammerPlugin");
            ...
            when(mockPluginManager.getPlugin("SpamHammer")).thenReturn(plugin);
